...
<body>
    <div class="profile-container">
        <img src="uploads/<?php echo htmlspecialchars($user['profile_picture']); ?>" alt="Product Image">
        <div class="profile-details">
            <h2><<?php //echo htmlspecialchars($user['name']); ?>Product Name</h2>
            <h6>Status: <?php //echo htmlspecialchars($user['email']); ?> Available</h6>
